...
# tickets
Product.first_or_create(name: 'Karnet OPEN', price: 150.0, description: '- 7 dni w tygodniu od 6:00 do 23:00 \n - wstęp wolny na zajęcia grupowe \n - profesjonalna pomoc trenerów', image: 'products/open.jpg', days: 30)
Product.first_or_create(name: 'Karnet HAPPY HOURS', price: 90.0, description: '- 5 dni w tygodniu od 8:00 do 17:00 \n - wstęp wolny na zajęcia grupowe \n - profesjonalna pomoc trenerów', image: 'products/happy_hours.jpg', days: 30)
Product.first_or_create(name: 'Karnet FITNESS', price: 90.0, description: '- 7 dni w tygodniu \n - duży wybór zajęć \n - nowoczesny sprzęt', image: 'products/fitness.jpg', days: 30)
